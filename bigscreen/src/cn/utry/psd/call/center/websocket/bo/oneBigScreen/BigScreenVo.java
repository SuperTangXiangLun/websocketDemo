 ...
 * 
 */
public class BigScreenVo implements Serializable {
	...
	public static BigScreenVo cloneRumTimeVo(RumTimeFromRedis fromRedis) {
		BigScreenVo rv = new BigScreenVo();
	...
	public String toString() {
		...
		str.append(uid).append(",").append(skillLine).append(",")
				...
				.append(serviceHorizontal).append(",").append(newDate);
		return str.toString();
	}
	//
	// 进线量 = 求和
