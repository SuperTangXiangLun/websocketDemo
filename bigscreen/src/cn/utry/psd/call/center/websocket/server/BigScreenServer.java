...
import cn.utry.psd.call.center.data.set.BigScreenDataOne;
 ...
 * @author sharkTang
 */
@ServerEndpoint(value = "/bigScreenServer")
@Component
public class BigScreenServer extends UtryWebSocketServer {
	private Logger logger_;

	public BigScreenServer() {
	...
	public String getSentData() {
		...
		List<Object> rtvos = BigScreenDataOne.setDataByTest();
		List<Object> chartDataBoList = BigScreenDataOne.makeBigScreenAllDataVoDate();
